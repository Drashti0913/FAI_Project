...
class DeliveryEnvironment:
    ...
    def __init__(self, num_drivers=1, grid_size=5, traffic_pattern='rush_hour', order_arrival_rate=0.3):
...
class DeliveryEnvironment:
    def __init__(self, num_drivers=3, grid_size=5, traffic_pattern='rush_hour', 
